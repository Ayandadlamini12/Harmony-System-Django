...
from .views import (
    ...
    navigation_summary, patient_flow_today_queue, PractitionerAvailabilityViewSet
)
...
urlpatterns = [
    ...
    path("patient-flow/today-queue/", patient_flow_today_queue, name="patient-flow-today-queue"),
] + router.urls
