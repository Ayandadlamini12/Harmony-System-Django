...
N8N_OUTBOUND_SECRET = os.getenv("N8N_OUTBOUND_SECRET", "")
N8N_CALLBACK_SECRET = os.getenv("N8N_CALLBACK_SECRET", "")
N8N_CALENDAR_SYNC_ENABLED = os.getenv("N8N_CALENDAR_SYNC_ENABLED", "false").lower() == "true"
N8N_CALENDAR_SYNC_WEBHOOK_URL = os.getenv("N8N_CALENDAR_SYNC_WEBHOOK_URL", "")
N8N_CALENDAR_SYNC_OUTBOUND_SECRET = os.getenv("N8N_CALENDAR_SYNC_OUTBOUND_SECRET", "")
TELEGRAM_VERIFICATION_BOT_USERNAME = os.getenv("TELEGRAM_VERIFICATION_BOT_USERNAME", "")
