...
const protectedPaths = ["/", "/patients", "/patient-flow", "/visits", "/vitals", "/drafts", "/check-ins", "/waiting-list", "/appointments", "/messages", "/account", "/users", "/employees", "/roles", "/teams", "/administration", "/approvals", "/access-requests"];
