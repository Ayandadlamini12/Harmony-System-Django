...
export async function updatePatient(id: string, formData: FormData) {
  ...
  const body = {
    ...
    telegram_username: optionalText(formData, "telegram_username"),
    preferred_notification_channel: optionalText(formData, "preferred_notification_channel") || null,
    notification_consent: formData.get("notification_consent") === "on",
