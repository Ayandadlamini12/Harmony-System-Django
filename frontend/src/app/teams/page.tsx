    ...
    <AppShell title="Teams">
      <div className="hh-panel p-5">
        <div className="flex items-center gap-3">
          <Users className="text-[var(--hh-purple)]" size={22} />
          <h2 className="font-bold">Teams</h2>
        </div>
        <p className="mt-2 max-w-3xl text-sm leading-6 text-[#66736d]">
          Future admin screen for grouping users into departments, clinical teams, reception teams, and operational units.
        </p>
